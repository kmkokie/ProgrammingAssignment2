...
## cacheSolve is the primary function that returns the inverse of the 
## matrix cached by the makeCacheMatrix
## Argument is a square, invertible matrix
## ASSUMPTIONS:  matrix supplied is a square matrix that is always invertible 

## makeCacheMatrix funtion
## This function creates a special "matrix" object that can cache its inverse.
## input:  a square, invertible matrix; 
## output: a list of functions to cache the inverse of input matrix
...
## input: cache matrixed object from the makeCacheMatrix function
## output:  inverse matrix of the specified
